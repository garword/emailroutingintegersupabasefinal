...
CREATE INDEX idx_email_routing_zone_id ON email_routing(zone_id);
CREATE INDEX idx_email_routing_rule_id ON email_routing(rule_id);
CREATE INDEX idx_email_routing_is_active ON email_routing(is_active);
